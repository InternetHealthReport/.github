...
This project and everyone participating in it is governed by the [IHR Code of Conduct](https://github.com/InternetHealthReport/.github/blob/main/CODE_OF_CONDUCT.md), please follow it in all your interaction with the project. By participating, you are expected to uphold this code. Please report unacceptable behavior to ihr-admin@iij-ii.co.jp
